...
const tinySuccess = transformFile(TINY_FLOW_TEST_PATH, INSTRUMENTED_TINY_FLOW_TEST_PATH);
if (tinySuccess) {
    const tinyExecutionSuccess = executeInstrumentedFile(INSTRUMENTED_TINY_FLOW_TEST_PATH, 'tiny Flow test');
...
const simpleSuccess = transformFile(SIMPLE_FLOW_TEST_PATH, INSTRUMENTED_SIMPLE_FLOW_TEST_PATH);
if (simpleSuccess) {
    const simpleExecutionSuccess = executeInstrumentedFile(INSTRUMENTED_SIMPLE_FLOW_TEST_PATH, 'simple Flow test');
...
const fullSuccess = transformFile(FULL_FLOW_TEST_PATH, INSTRUMENTED_FULL_FLOW_TEST_PATH);
if (fullSuccess) {
    const fullExecutionSuccess = executeInstrumentedFile(INSTRUMENTED_FULL_FLOW_TEST_PATH, 'full Flow test');
