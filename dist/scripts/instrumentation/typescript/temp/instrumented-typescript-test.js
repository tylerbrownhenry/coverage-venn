...
function _regeneratorRuntime() {
    ...
    var d = Object.getPrototypeOf, v = COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "hsb46pue5", "logical-&&", d) && d(d(values([])));
    COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "g72ju1r0w", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "8sausbu8m", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "puo2doux5", "logical-&&", v) && v !== r) && n.call(v, a)) && (p = v);
    ...
    function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if (COVERAGE_TRACKER.trackBranch("invoke", "dkdhz48cr", "if", "throw" !== c.type)) {
        var u = c.arg, h = u.value;
        return COVERAGE_TRACKER.trackBranch("invoke", "29ul1ah6k", "ternary", COVERAGE_TRACKER.trackBranch("invoke", "75jpilaz1", "logical-&&", COVERAGE_TRACKER.trackBranch("invoke", "9hbez8h0d", "logical-&&", h) && "object" == _typeof(h)) && n.call(h, "__await")) ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); });
    } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = COVERAGE_TRACKER.trackBranch("AsyncIterator", "fmpg44vn", "ternary", r) ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); }
    function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "sahkw96s8", "if", o === f))
        throw Error("Generator is already running"); if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "jd5xq7tz9", "if", o === s)) {
        if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "ea06kbxbd", "if", "throw" === i))
            throw a;
        return { value: t, done: !0 };
    } for (n.method = i, n.arg = a;;) {
        var c = n.delegate;
        if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "ca7exj4jy", "if", c)) {
            var u = maybeInvokeDelegate(c, n);
            if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "t0pqoq9ph", "if", u)) {
                if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "vtd0wjs2q", "if", u === y))
                    continue;
                return u;
            }
        }
        if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "hnbfxbg8i", "if", "next" === n.method))
            n.sent = n._sent = n.arg;
        else if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "p9gat37lw", "if", "throw" === n.method)) {
            if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "mwjzrdoia", "if", o === h))
                throw o = s, n.arg;
            n.dispatchException(n.arg);
        }
        else
            COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "i2dkzl0te", "logical-&&", "return" === n.method) && n.abrupt("return", n.arg);
        o = f;
        var p = tryCatch(e, r, n);
        if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "zsrq04su6", "if", "normal" === p.type)) {
            if (COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "tgct37s5z", "if", (o = COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "f78cyhjly", "ternary", n.done) ? s : l, p.arg === y)))
                continue;
            return { value: p.arg, done: n.done };
        }
        COVERAGE_TRACKER.trackBranch("makeInvokeMethod", "hycnxy2tr", "logical-&&", "throw" === p.type) && (o = s, n.method = "throw", n.arg = p.arg);
    } }; }
    function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "juznnq1af", "if", o === t))
        return r.delegate = null, COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "stzkh9ykg", "logical-||", COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "fv7ddu8jk", "logical-&&", COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "nrn1buzna", "logical-&&", "throw" === n) && e.iterator["return"]) && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method)) || COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "uyj3y204a", "logical-&&", "return" !== n) && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if (COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "3cq9r1uyc", "if", "throw" === i.type))
        return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "dp6yuje11", "ternary", a) ? COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "0n1lknu1j", "ternary", a.done) ? (r[e.resultName] = a.value, r.next = e.nextLoc, COVERAGE_TRACKER.trackBranch("maybeInvokeDelegate", "e7o049onm", "logical-&&", "return" !== r.method) && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); }
    function pushTryEntry(t) { var e = { tryLoc: t[0] }; COVERAGE_TRACKER.trackBranch("pushTryEntry", "65bklz65j", "logical-&&", 1 in t) && (e.catchLoc = t[1]), COVERAGE_TRACKER.trackBranch("pushTryEntry", "u363nsxkn", "logical-&&", 2 in t) && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); }
    function resetTryEntry(t) { var e = COVERAGE_TRACKER.trackBranch("resetTryEntry", "nxeewbnw6", "logical-||", t.completion) || {}; e.type = "normal", delete e.arg, t.completion = e; }
    function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); }
    function values(e) { if (COVERAGE_TRACKER.trackBranch("values", "30w2tjgpc", "if", COVERAGE_TRACKER.trackBranch("values", "e3agib1o6", "logical-||", e) || "" === e)) {
        var r = e[a];
        if (COVERAGE_TRACKER.trackBranch("values", "fnqygzha0", "if", r))
            return r.call(e);
        if (COVERAGE_TRACKER.trackBranch("values", "27xh8mfy1", "if", "function" == typeof e.next))
            return e;
        if (COVERAGE_TRACKER.trackBranch("values", "58d7lg45g", "if", !isNaN(e.length))) {
            var o = -1, i = function next() { for (; ++o < e.length;)
                if (COVERAGE_TRACKER.trackBranch("i", "476su8wte", "if", n.call(e, o)))
    ...
    return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "xd7fsz0dm", "logical-&&", "function" == typeof t) && t.constructor; return COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "zo6scfbqv", "logical-&&", !!e) && (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "4olpov9pa", "logical-||", e === GeneratorFunction) || "GeneratorFunction" === (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "4ewtmzliu", "logical-||", e.displayName) || e.name)); }, e.mark = function (t) { return COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "ifnf0vv19", "ternary", Object.setPrototypeOf) ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "iqpzoh865", "logical-&&", void 0 === i) && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "rb7f4tbyw", "ternary", e.isGeneratorFunction(r)) ? a : a.next().then(function (t) { return COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "6u0bahx1m", "ternary", t.done) ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e)
        ...
        var t = r.pop();
        if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "mjj7wnayd", "if", t in e))
            return next.value = t, next.done = !1, next;
    } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "n0p465oqw", "if", (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e)))
            for (var r in this)
                COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "ae39vkxew", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "bfxoa7tag", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "fky3g0jez", "logical-&&", "t" === r.charAt(0)) && n.call(this, r)) && !isNaN(+r.slice(1))) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "c16agsrug", "if", "throw" === t.type))
            throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "qv3xcr0eg", "if", this.done))
            throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, COVERAGE_TRACKER.trackBranch("handle", "2t5q3ktey", "logical-&&", o) && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) {
            var i = this.tryEntries[o], a = i.completion;
            if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "vt4650eqa", "if", "root" === i.tryLoc))
                return handle("end");
            if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "hlj8d5502", "if", i.tryLoc <= this.prev)) {
                var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc");
                if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "xq2oqh6sc", "if", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "cmu5lvs2v", "logical-&&", c) && u)) {
                    if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "166tm9d7h", "if", this.prev < i.catchLoc))
                        return handle(i.catchLoc, !0);
                    if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "dub78hykr", "if", this.prev < i.finallyLoc))
                        return handle(i.finallyLoc);
                }
                else if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "q54chx9s8", "if", c)) {
                    if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "ee8x08jtt", "if", this.prev < i.catchLoc))
                        return handle(i.catchLoc, !0);
                }
                else {
                    if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "65rhqz28t", "if", !u))
                        throw Error("try statement without catch or finally");
                    if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "dfdzeazil", "if", this.prev < i.finallyLoc))
                        return handle(i.finallyLoc);
                }
            }
        } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) {
            var o = this.tryEntries[r];
            if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "1he4qs9la", "if", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "et6mtg2tk", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "4dgu9tbsc", "logical-&&", o.tryLoc <= this.prev) && n.call(o, "finallyLoc")) && this.prev < o.finallyLoc)) {
                var i = o;
                break;
            }
        } COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "6i7tmpm0h", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "tp7qvnajx", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "egb62ns64", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "noc13r43o", "logical-&&", i) && (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "wyhuyp2ee", "logical-||", "break" === t) || "continue" === t)) && i.tryLoc <= e) && e <= i.finallyLoc) && (i = null); var a = COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "5qh7p55rc", "ternary", i) ? i.completion : {}; return a.type = t, a.arg = e, COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "wgzlz18w1", "ternary", i) ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "t6ok0h2pk", "if", "throw" === t.type))
            throw t.arg; return COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "sukg2z2tw", "ternary", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "xoa40eify", "logical-||", "break" === t.type) || "continue" === t.type) ? this.next = t.arg : COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "hg078wj9n", "ternary", "return" === t.type) ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "y5b8zwh6m", "logical-&&", COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "by80fsvxs", "logical-&&", "normal" === t.type) && e) && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) {
            var r = this.tryEntries[e];
            if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "503mk9ga4", "if", r.finallyLoc === t))
            ...
            var r = this.tryEntries[e];
            if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "fhacf7sbm", "if", r.tryLoc === t)) {
                var n = r.completion;
                if (COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "0jpev696v", "if", "throw" === n.type)) {
                    var o = n.arg;
                    resetTryEntry(r);
                }
                return o;
            }
        } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, COVERAGE_TRACKER.trackBranch("_regeneratorRuntime", "gy3i7olyt", "logical-&&", "next" === this.method) && (this.arg = t), y; } }, e;
}
function ownKeys(e, r) { var t = Object.keys(e); if (COVERAGE_TRACKER.trackBranch("ownKeys", "vl4sfx3ft", "if", Object.getOwnPropertySymbols)) {
    var o = Object.getOwnPropertySymbols(e);
    COVERAGE_TRACKER.trackBranch("ownKeys", "lyupkh6kx", "logical-&&", r) && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o);
} return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) {
    var t = COVERAGE_TRACKER.trackBranch("_objectSpread", "peyd6ne73", "ternary", null != arguments[r]) ? arguments[r] : {};
    COVERAGE_TRACKER.trackBranch("_objectSpread", "uk0gn4bxx", "ternary", r % 2) ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : COVERAGE_TRACKER.trackBranch("_objectSpread", "yk57py3oq", "ternary", Object.getOwnPropertyDescriptors) ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); });
} return e; }
...
function _toPrimitive(t, r) { if (COVERAGE_TRACKER.trackBranch("_toPrimitive", "plxmoaz20", "if", COVERAGE_TRACKER.trackBranch("_toPrimitive", "rbgis8pgs", "logical-||", "object" != _typeof(t)) || !t))
    return t; var e = t[Symbol.toPrimitive]; if (COVERAGE_TRACKER.trackBranch("_toPrimitive", "oeh3v1lhl", "if", void 0 !== e)) {
    var i = e.call(t, COVERAGE_TRACKER.trackBranch("_toPrimitive", "h53r983zd", "logical-||", r) || "default");
    if (COVERAGE_TRACKER.trackBranch("_toPrimitive", "hmd7syshu", "if", "object" != _typeof(i)))
        return i;
    throw new TypeError("@@toPrimitive must return a primitive value.");
} return (COVERAGE_TRACKER.trackBranch("_toPrimitive", "nkht72hlk", "ternary", "string" === r) ? String : Number)(t); }
function _typeof(o) {
    "@babel/helpers - typeof";
    return _typeof = COVERAGE_TRACKER.trackBranch("_typeof", "bm4cfg8kd", "ternary", COVERAGE_TRACKER.trackBranch("_typeof", "apbs55ugj", "logical-&&", "function" == typeof Symbol) && "symbol" == typeof Symbol.iterator) ? function (o) { return typeof o; } : function (o) { return COVERAGE_TRACKER.trackBranch("_typeof", "h198p1o1u", "ternary", COVERAGE_TRACKER.trackBranch("_typeof", "4v83jshy4", "logical-&&", COVERAGE_TRACKER.trackBranch("_typeof", "puep6sya2", "logical-&&", COVERAGE_TRACKER.trackBranch("_typeof", "nm4i3aowf", "logical-&&", o) && "function" == typeof Symbol) && o.constructor === Symbol) && o !== Symbol.prototype) ? "symbol" : typeof o; }, _typeof(o);
}
function asyncGeneratorStep(n, t, e, r, o, a, c) { try {
    ...
    return void e(n);
} COVERAGE_TRACKER.trackBranch("asyncGeneratorStep", "1qcgfgjm0", "ternary", i.done) ? t(u) : Promise.resolve(u).then(r, o); }
