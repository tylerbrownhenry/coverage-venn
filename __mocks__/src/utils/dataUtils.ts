 ...
 */
export function processData(items: any[], options: {
  validate?: boolean;
  transform?: boolean;
  sort?: 'asc' | 'desc' | null;
  limit?: number;
 ...
 */
function transformItem(item: any): DataItem {
 ...
 */
function normalizeItem(item: any): DataItem {
  return {
    id: item.id,
    value: item.value,
