...
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = (COVERAGE_TRACKER.trackBranch("App", 114, "ternary", "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? 0 : 1), "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }), _typeof(o); }
...
function _getRequireWildcardCache(e) { COVERAGE_TRACKER.trackBranch("App", 97, "if", "function" != typeof WeakMap ? 0 : 1); if ("function" != typeof WeakMap) return null; var r = new WeakMap(), t = new WeakMap(); return (_getRequireWildcardCache = function _getRequireWildcardCache(e) { return COVERAGE_TRACKER.trackBranch("App", 98, "ternary", e ? 0 : 1), e ? t : r; })(e); }
function _interopRequireWildcard(e, r) { COVERAGE_TRACKER.trackBranch("App", 99, "if", !r && e && e.__esModule ? 0 : 1); if (COVERAGE_TRACKER.trackBranch("App", 100, "logical", !r && e ? 0 : 1), !r && e && e.__esModule) return e; COVERAGE_TRACKER.trackBranch("App", 101, "if", null === e || "object" != _typeof(e) && "function" != typeof e ? 0 : 1); if (COVERAGE_TRACKER.trackBranch("App", 102, "logical", null === e ? 1 : 0), null === e || "object" != typeof e && "function" != typeof e) return { "default": e }; var t = _getRequireWildcardCache(r); COVERAGE_TRACKER.trackBranch("App", 103, "if", t && t.has(e) ? 0 : 1); if (COVERAGE_TRACKER.trackBranch("App", 104, "logical", t ? 0 : 1), t && t.has(e)) return t.get(e); var n = { __proto__: null }, a = (COVERAGE_TRACKER.trackBranch("App", 105, "logical", Object.defineProperty ? 0 : 1), Object.defineProperty && Object.getOwnPropertyDescriptor); for (var u in e) { COVERAGE_TRACKER.trackBranch("App", 106, "if", "default" !== u && {}.hasOwnProperty.call(e, u) ? 0 : 1); COVERAGE_TRACKER.trackBranch("App", 107, "if", "default" !== u && {}.hasOwnProperty.call(e, u) ? 0 : 1); if (COVERAGE_TRACKER.trackBranch("App", 108, "logical", "default" !== u ? 0 : 1), "default" !== u && {}.hasOwnProperty.call(e, u)) { var i = (COVERAGE_TRACKER.trackBranch("App", 109, "ternary", a ? 0 : 1), a ? Object.getOwnPropertyDescriptor(e, u) : null); COVERAGE_TRACKER.trackBranch("App", 110, "ternary", i && (i.get || i.set) ? 0 : 1); (COVERAGE_TRACKER.trackBranch("App", 111, "logical", i ? 0 : 1), i && (i.get || i.set)) ? Object.defineProperty(n, u, i) : n[u] = e[u]; } } return n["default"] = e, COVERAGE_TRACKER.trackBranch("App", 112, "logical", t ? 0 : 1), t && t.set(e, n), n; }
...
function _unsupportedIterableToArray(r, a) { COVERAGE_TRACKER.trackBranch("App", 92, "if", r ? 0 : 1); if (r) { COVERAGE_TRACKER.trackBranch("App", 93, "if", "string" == typeof r ? 0 : 1); if ("string" == typeof r) return _arrayLikeToArray(r, a); var t = {}.toString.call(r).slice(8, -1); return COVERAGE_TRACKER.trackBranch("App", 94, "logical", "Object" === t && r.constructor ? 0 : 1), "Object" === t && r.constructor && (t = r.constructor.name), COVERAGE_TRACKER.trackBranch("App", 95, "ternary", "Map" === t || "Set" === t ? 0 : 1), "Map" === t || "Set" === t ? Array.from(r) : "Arguments" === t || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t) ? _arrayLikeToArray(r, a) : void 0; } }
function _arrayLikeToArray(r, a) { COVERAGE_TRACKER.trackBranch("App", 90, "logical", null == a || a > r.length ? 0 : 1); (COVERAGE_TRACKER.trackBranch("App", 91, "logical", null == a ? 1 : 0), null == a || a > r.length) && (a = r.length); for (var e = 0, n = Array(a); e < a; e++) n[e] = r[e]; return n; }
function _iterableToArrayLimit(r, l) { var t = (COVERAGE_TRACKER.trackBranch("App", 82, "ternary", null == r ? 0 : 1), null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]); COVERAGE_TRACKER.trackBranch("App", 83, "if", null != t ? 0 : 1); if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { COVERAGE_TRACKER.trackBranch("App", 84, "if", (i = (t = t.call(r)).next, 0 === l) ? 0 : 1); if (i = (t = t.call(r)).next, 0 === l) { COVERAGE_TRACKER.trackBranch("App", 85, "if", Object(t) !== t ? 0 : 1); if (Object(t) !== t) return; f = !1; } else for (; COVERAGE_TRACKER.trackBranch("App", 86, "logical", !(f = (e = i.call(t)).done) ? 0 : 1), !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { COVERAGE_TRACKER.trackBranch("App", 87, "if", !f && null != t["return"] && (u = t["return"](), Object(u) !== u) ? 0 : 1); if (COVERAGE_TRACKER.trackBranch("App", 88, "logical", !f && null != t.return ? 0 : 1), !f && null != t.return && (u = t.return(), Object(u) !== u)) return; } finally { COVERAGE_TRACKER.trackBranch("App", 89, "if", o ? 0 : 1); if (o) throw n; } } return a; } }
function _arrayWithHoles(r) { COVERAGE_TRACKER.trackBranch("App", 81, "if", Array.isArray(r) ? 0 : 1); if (Array.isArray(r)) return r; }
/**
...
function App() {
  var _useState = (0, _react.useState)(true),
    ...
    showComponents = _useState2[0],
    setShowComponents = _useState2[1];
  var _useState3 = (0, _react.useState)('simple'),
