...
function createFunctionTrackingWrapper(componentName, functionName, functionId, bodyStatements) {
  ...
  const startTrackingCall = t.expressionStatement(
    t.callExpression(
      t.memberExpression(
        ...
        t.identifier('trackFunctionStart')
      ),
      [
  ...
  const endTrackingCall = t.expressionStatement(
    t.callExpression(
      t.memberExpression(
        t.identifier('COVERAGE_TRACKER'),
        t.identifier('trackFunctionEnd')
      ),
      [
        t.stringLiteral(componentName),
        t.stringLiteral(functionName),
  ...
  const errorTrackingCall = t.expressionStatement(
    t.callExpression(
      t.memberExpression(
        t.identifier('COVERAGE_TRACKER'),
        t.identifier('trackFunctionError')
      ),
      [
        t.stringLiteral(componentName),
        t.stringLiteral(functionName),
  ...
  return {
    ...
    visitor: {
      ...
      FunctionDeclaration(path, state) {
        ...
        const newBody = createFunctionTrackingWrapper(
          componentName,
          functionName,
          functionId,
          bodyStatements
